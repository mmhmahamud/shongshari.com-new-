          ...
          <section>
            <div className="flex items-center bg-gray-100 p-3 w-full rounded-lg mt-3 lg:mt-0">
              ...
              >
                ...
                <option value="would like to have some">
          ...
          <section>
            <div className="flex items-center bg-gray-100 p-3 w-full rounded-lg mt-3 lg:mt-0">
              ...
              >
                ...
                <option value="not interested in voluntaring">
            ...
            <h1 className="text-left ml-2">
              {errors.haveVoluntaryExp?.type === "required" && (
                <span className="w-full text-left text-red-400 text-sm">
                  {errors?.haveVoluntaryExp.message}
                </span>
              )}
            </h1>
          </section>
          ...
          <section>
            <div className="flex items-center bg-gray-100 p-3 w-full rounded-lg mt-3 lg:mt-0">
              ...
              >
                ...
                <option value="not interested in travelling">
            ...
            <h1 className="text-left ml-2">
              {errors.travelledOutsideBangladesh?.type === "required" && (
                <span className="w-full text-left text-red-400 text-sm">
                  {errors?.travelledOutsideBangladesh.message}
                </span>
              )}
            </h1>
          </section>
          ...
          <section>
            <div className="flex items-center bg-gray-100 p-3 w-full rounded-lg mt-3 lg:mt-0">
              ...
              >
                ...
                <option value="I Don't Like Children">
