...
import {
  default as p3,
  default as p4,
} from "../../assets/images/features/i3.png";
        ...
        <div className="section-header">
          <div className="text-center mb-6">
            <h1 className="text-4xl font-semibold text-red-600">
              An Executive List Of
            </h1>
            <h2 className="text-2xl font-semibold text-red-400 py-6">
              Amazing feature
            </h2>
        ...
        <div className="section-body pt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative">
              ...
              <div className="section-img-container w-full md:w-11/12 z-0"></div>
            </div>
