    ...
    <div className="bg-[#FAFBFF]">
      ...
      {!isEmailVerified && (
        <div className="absolute top-[50%] left-[50%] text-[30px] z-50 bg-white px-4 py-4 shadow-lg w-[260px]">
          <h3 className="text-[22px] font-Inter font-bold">
            Verify your email
          </h3>
          <p className="max-w-[320px] text-[14px]">
            Hi <span className="font-semibold">{firstName}!</span> use the link
            below to verify your email and start enjoying songshari.com
          </p>
      ...
      <div
        className={`custom-container mx-auto bg-[#FAFBFF] pt-[30px] ${
          !isEmailVerified && "blur-[7px]"
        }`}
      >
